...
results = []
for i in sub_links:
    matches = i.find('a')['href']
    results.append(matches)
    matches_1 = i.find('a')['title']
...
# This weird loops need to stay for know, since for loop uses more than just short_results, and it's a little bit complicated
a = 0
